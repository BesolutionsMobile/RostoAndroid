package com.besolutions.rosto.Scenarios.ScenarioThree.Pattrens;
...
public class ExpandableTextViewAdabter extends BaseExpandableListAdapter implements NetworkInterface {
    Context context;
